...
TICKER_MAP = {
    ...
    # Added 2026-06-02
    "pbfenergyinc-classa": ("PBF", "PBF", "Stock"),
    "tkogroupholdingsinc": ("TKO", "TKO", "Stock"),
    "bankofamericacorp": ("BAC", "BAC", "Stock"),
    "carrierglobalcorp": ("CARR", "CARR", "Stock"),
    "guidewiresoftwareinc": ("GWRE", "GWRE", "Stock"),
    "sterlinginfrastructureinc": ("STRL", "STRL", "Stock"),
    "coherentcorp": ("COHR", "COHR", "Stock"),
    "palantirtechnologiesinc-a": ("PLTR", "PLTR", "Stock"),
    "appliedoptoelectronicsinc": ("AAOI", "AAOI", "Stock"),
    "spaceexplorationtechn-cla": ("SPCX", "SPCX", "Stock"),
    "stonexgroupinc": ("SNEX", "SNEX", "Stock"),
    "rackspacetechnologyinc": ("RXT", "RXT", "Stock"),
    "invesconasdaq100etf": ("QQQM", "QQQM", "ETF"),
    "qnityelectronicsinc": ("Q", "Q", "Stock"),
    "nebiusgroupnv": ("NBIS", "NBIS", "Stock"),
    "latticesemiconductorcorp": ("LSCC", "LSCC", "Stock"),
    "lumentumholdingsinc": ("LITE", "LITE", "Stock"),
    "irenltd": ("IREN", "IREN", "Stock"),
    "samsarainc-cla": ("IOT", "IOT", "Stock"),
    "ichorholdingsltd": ("ICHR", "ICHR", "Stock"),
    "hewlettpackardenterprise": ("HPE", "HPE", "Stock"),
    "spdrgoldminisharestrust": ("GLDM", "GLDM", "ETF"),
    "forgentpowersolutions-cla": ("FPS", "FPS", "Stock"),
    "duluthholdingsinc-clb": ("DLTH", "DLTH", "Stock"),
    "ciscosystemsinc": ("CSCO", "CSCO", "Stock"),
    "centenecorp": ("CNC", "CNC", "Stock"),
    "brightspringhealthservices": ("BTSG", "BTSG", "Stock"),
    "applieddigitalcorp": ("APLD", "APLD", "Stock"),
    "advancedmicrodevices": ("AMD", "AMD", "Stock"),
