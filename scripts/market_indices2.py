...
# ── INDIA HOLDINGS ───────────────────────────────────────────────────────────
# NSE tickers verified on yfinance/Yahoo Finance
INDIA_HOLDINGS = [
    # (yfinance_ticker,    display_name,                    broker,    qty,    purchase_px)
    # Tickers verified against Yahoo Finance NSE listings
    ("IRBINVIT.NS",       "IRB InvIT Fund",                "Motilal", 507,    60.26  ),
    ("ASHALOG.NS",        "Asha Logistics",                "Mstock",  1000,   64.70  ),  # FIXED: ASHALOG not ASHALOGIS
    ("AVADHSUGAR.NS",     "Avadh Sugar & Energy Ltd",      "Motilal", 248,    405.13 ),
    ("DIACABS.NS",        "Diamond Power Infrastructure",  "Mstock",  100,    154.21 ),  # FIXED: DIACABS not DIAMONDPWR
    ("FILATFASH.NS",      "Filatex Fashions Ltd",          "Upstox",  90000,  0.24   ),
    ...
    ("PARAMATX.NS",       "Paramatrix Technologies",       "Motilal", 2400,   82.86  ),  # Try PARAMATX
